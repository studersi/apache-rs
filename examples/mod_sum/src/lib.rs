...
use apache_rs::ffi::bindgen::DECLINED;
use apache_rs::ffi::bindgen::HTTP_FORBIDDEN;
use apache_rs::ffi::bindgen::HTTP_NOT_FOUND;
use apache_rs::ffi::bindgen::MODULE_MAGIC_COOKIE;
use apache_rs::ffi::bindgen::MODULE_MAGIC_NUMBER_MAJOR;
use apache_rs::ffi::bindgen::MODULE_MAGIC_NUMBER_MINOR;
use apache_rs::ffi::bindgen::OK;
use apache_rs::ffi::bindgen::ap_args_to_table;
use apache_rs::ffi::bindgen::ap_hook_handler;
use apache_rs::ffi::bindgen::ap_rprintf;
use apache_rs::ffi::bindgen::ap_set_content_type;
use apache_rs::ffi::bindgen::apr_pool_t;
use apache_rs::ffi::bindgen::command_struct;
use apache_rs::ffi::bindgen::module;
use apache_rs::ffi::bindgen::request_rec;
use apache_rs::ffi::bindgen::strcmp;
use apache_rs::ffi::bindgen::{APR_HOOK_MIDDLE, apr_table_get, apr_table_make};
use core::ffi::CStr;
use md5;
use sha1::Digest;
use sha1::Sha1;
